...
Opal.modules["nodejs/io"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var $a, $b, $c, $d, TMP_1, $e, TMP_2, self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice;

  Opal.add_stubs(['$write_proc=', '$lambda', '$tty=']);
  (($a = [($c = ($d = self).$lambda, $c.$$p = (TMP_1 = function(string){var self = TMP_1.$$s || this;
if (string == null) string = nil;
  return process.stdout.write(string);}, TMP_1.$$s = self, TMP_1), $c).call($d)]), $b = $scope.get('STDOUT'), $b['$write_proc='].apply($b, $a), $a[$a.length-1]);
  (($a = [($c = ($e = self).$lambda, $c.$$p = (TMP_2 = function(string){var self = TMP_2.$$s || this;
if (string == null) string = nil;
  return process.stderr.write(string);}, TMP_2.$$s = self, TMP_2), $c).call($e)]), $b = $scope.get('STDERR'), $b['$write_proc='].apply($b, $a), $a[$a.length-1]);
...
/* Generated by Opal 0.9.2 */
Opal.modules["paint/version"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module;
  ...
  return (function($base) {
    var $Paint, self = $Paint = $module($base, 'Paint');

    var def = self.$$proto, $scope = self.$$scope;

    Opal.cdecl($scope, 'VERSION', "1.0.1".$freeze())
  })($scope.base)
};
...
/* Generated by Opal 0.9.2 */
Opal.modules["paint/util"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  ...
  Opal.add_stubs(['$require', '$gsub', '$each', '$print', '$[]', '$puts', '$file?', '$clear', '$open', '$each_line', '$=~', '$chomp', '$[]=', '$to_i', '$raise']);
  ...
  return (function($base) {
    ...
    (function(self) {
      ...
      Opal.defn(self, '$unpaint', function(string) {
        var self = this;

        return string.$gsub(/\e\[(?:[0-9];?)+m/, "");
      });
      Opal.defn(self, '$rainbow', function() {
        var $a, $b, TMP_1, self = this;

        ($a = ($b = ($range(0, 256, true))).$each, $a.$$p = (TMP_1 = function(color){var self = TMP_1.$$s || this;
if (color == null) color = nil;
        return self.$print($scope.get('Paint')['$[]'](" ", 48, 5, color))}, TMP_1.$$s = self, TMP_1), $a).call($b);
        return self.$puts();
      });
      return (Opal.defn(self, '$update_rgb_colors', function(path) {
        var $a, $b, TMP_2, self = this;

        if (path == null) {
          path = "/etc/X11/rgb.txt"
        }
        if ((($a = $scope.get('File')['$file?'](path)) !== nil && (!$a.$$is_boolean || $a == true))) {
          (($scope.get('Paint')).$$scope.get('RGB_COLORS')).$clear();
          return ($a = ($b = $scope.get('File')).$open, $a.$$p = (TMP_2 = function(file){var self = TMP_2.$$s || this, $a, $b, TMP_3;
if (file == null) file = nil;
          return ($a = ($b = file).$each_line, $a.$$p = (TMP_3 = function(line){var self = TMP_3.$$s || this, $a, $b;
if (line == null) line = nil;
            line.$chomp()['$=~'](/(\d+)\s+(\d+)\s+(\d+)\s+(.*)$/);
              if ((($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](4))) !== nil && (!$a.$$is_boolean || $a == true))) {
                return (($scope.get('Paint')).$$scope.get('RGB_COLORS'))['$[]=']((($a = $gvars['~']) === nil ? nil : $a['$[]'](4)), [(($a = $gvars['~']) === nil ? nil : $a['$[]'](1)).$to_i(), (($a = $gvars['~']) === nil ? nil : $a['$[]'](2)).$to_i(), (($a = $gvars['~']) === nil ? nil : $a['$[]'](3)).$to_i()])
                } else {
                return nil
              };}, TMP_3.$$s = self, TMP_3), $a).call($b)}, TMP_2.$$s = self, TMP_2), $a).call($b, path, "r");
          } else {
          return self.$raise($scope.get('ArgumentError'), "Not a valid file: " + (path))
        };
      }), nil) && 'update_rgb_colors';
    })(Opal.get_singleton_class(self))
  })($scope.base);
};

/* Generated by Opal 0.9.2 */
Opal.modules["paint/rgb_colors"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $hash2 = Opal.hash2;
...
Opal.modules["paint"] = function(Opal) {
  ...
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $hash2 = Opal.hash2, $range = Opal.range;

  Opal.add_stubs(['$autoload', '$freeze', '$zero?', '$empty?', '$to_s', '$==', '$size', '$!', '$respond_to?', '$first', '$+', '$[]', '$each', '$===', '$<<', '$key?', '$effect', '$raise', '$all?', '$is_a?', '$rgb', '$=~', '$hex', '$rgb_name', '$to_i', '$include?', '$inspect', '$wrap', '$attr_reader', '$clear', '$*', '$rgb_like_value', '$rgb_value', '$tr', '$map', '$join', '$each_slice', '$each_char', '$rand', '$private', '$<', '$round', '$/', '$to_f', '$inject', '$zip', '$values', '$min_by', '$distance', '$send', '$**', '$-', '$detect_mode', '$new', '$[]=', '$color']);
  self.$require("paint"+ '/../' + "paint/version");
  self.$require("paint"+ '/../' + "paint/util");
  return (function($base) {
    var $Paint, self = $Paint = $module($base, 'Paint');

    var def = self.$$proto, $scope = self.$$scope, $a, $b, TMP_8;

    self.$autoload("RGB_COLORS", "paint/rgb_colors");

    self.$autoload("RGB_COLORS_ANSI", "paint/rgb_colors_ansi");

    Opal.cdecl($scope, 'NOTHING', "\u001b[0m".$freeze());

    Opal.cdecl($scope, 'ANSI_COLORS', $hash2(["black", "red", "green", "yellow", "blue", "magenta", "cyan", "white", "default"], {"black": 0, "red": 1, "green": 2, "yellow": 3, "blue": 4, "magenta": 5, "cyan": 6, "white": 7, "default": 9}).$freeze());

    Opal.cdecl($scope, 'ANSI_EFFECTS', $hash2(["reset", "nothing", "bright", "bold", "faint", "italic", "underline", "blink", "slow_blink", "rapid_blink", "inverse", "swap", "conceal", "hide", "default_font", "font0", "font1", "font2", "font3", "font4", "font5", "font6", "font7", "font8", "font9", "fraktur", "bright_off", "bold_off", "double_underline", "clean", "italic_off", "fraktur_off", "underline_off", "blink_off", "inverse_off", "positive", "conceal_off", "show", "reveal", "crossed_off", "crossed_out_off", "frame", "encircle", "overline", "frame_off", "encircle_off", "overline_off"], {"reset": 0, "nothing": 0, "bright": 1, "bold": 1, "faint": 2, "italic": 3, "underline": 4, "blink": 5, "slow_blink": 5, "rapid_blink": 6, "inverse": 7, "swap": 7, "conceal": 8, "hide": 9, "default_font": 10, "font0": 10, "font1": 11, "font2": 12, "font3": 13, "font4": 14, "font5": 15, "font6": 16, "font7": 17, "font8": 18, "font9": 19, "fraktur": 20, "bright_off": 21, "bold_off": 21, "double_underline": 21, "clean": 22, "italic_off": 23, "fraktur_off": 23, "underline_off": 24, "blink_off": 25, "inverse_off": 26, "positive": 26, "conceal_off": 27, "show": 27, "reveal": 27, "crossed_off": 29, "crossed_out_off": 29, "frame": 51, "encircle": 52, "overline": 53, "frame_off": 54, "encircle_off": 54, "overline_off": 55}).$freeze());

    Opal.cdecl($scope, 'ANSI_COLORS_FOREGROUND', $hash2(["black", "red", "green", "yellow", "blue", "magenta", "cyan", "white", "default"], {"black": 30, "red": 31, "green": 32, "yellow": 33, "blue": 34, "magenta": 35, "cyan": 36, "white": 37, "default": 39}).$freeze());

    Opal.cdecl($scope, 'ANSI_COLORS_BACKGROUND', $hash2(["black", "red", "green", "yellow", "blue", "magenta", "cyan", "white", "default"], {"black": 40, "red": 41, "green": 42, "yellow": 43, "blue": 44, "magenta": 45, "cyan": 46, "white": 47, "default": 49}).$freeze());
    ...
    (function(self) {
      ...
      Opal.defn(self, '$[]', function(string) {
        ...
        var array_size = arguments.length - 1;
        if(array_size < 0) array_size = 0;
        var options = new Array(array_size);
        for($splat_index = 0; $splat_index < array_size; $splat_index++) {
          options[$splat_index] = arguments[$splat_index + 1];
        }
        if ((($a = ((($b = self.mode['$zero?']()) !== false && $b !== nil) ? $b : options['$empty?']())) !== nil && (!$a.$$is_boolean || $a == true))) {
          return string.$to_s()};
        if ((($a = (($b = options.$size()['$=='](1)) ? options.$first()['$respond_to?']("to_ary")['$!']() : options.$size()['$=='](1))) !== nil && (!$a.$$is_boolean || $a == true))) {
          options = options.$first()};
        return $rb_plus($rb_plus(self.cache['$[]'](options), string.$to_s()), $scope.get('NOTHING'));
      });
      Opal.defn(self, '$color', function() {
        var $a, $b, TMP_1, self = this, mix = nil, color_seen = nil, colors = nil, $splat_index = nil;
        if (self.mode == null) self.mode = nil;
        ...
        var options = new Array(array_size);
        for($splat_index = 0; $splat_index < array_size; $splat_index++) {
          options[$splat_index] = arguments[$splat_index + 0];
        }
        if ((($a = ((($b = self.mode['$zero?']()) !== false && $b !== nil) ? $b : options['$empty?']())) !== nil && (!$a.$$is_boolean || $a == true))) {
          return ""};
        mix = [];
        color_seen = false;
        colors = $scope.get('ANSI_COLORS_FOREGROUND');
        ($a = ($b = options).$each, $a.$$p = (TMP_1 = function(option){var self = TMP_1.$$s || this, $a, $b, $c, $d, TMP_2, $case = nil, color = nil, integer = nil;
if (option == null) option = nil;
        $case = option;if ($scope.get('Symbol')['$===']($case)) {if ((($a = color = colors['$[]'](option)) !== nil && (!$a.$$is_boolean || $a == true))) {
            mix['$<<'](color);
            color_seen = "set";
          } else if ((($a = $scope.get('ANSI_EFFECTS')['$key?'](option)) !== nil && (!$a.$$is_boolean || $a == true))) {
            mix['$<<'](self.$effect(option))
            } else {
            self.$raise($scope.get('ArgumentError'), "Unknown color or effect: " + (option))
          }}else if ($scope.get('Array')['$===']($case)) {if ((($a = (($b = option.$size()['$=='](3)) ? ($c = ($d = option)['$all?'], $c.$$p = (TMP_2 = function(n){var self = TMP_2.$$s || this;
if (n == null) n = nil;
          return n['$is_a?']($scope.get('Numeric'))}, TMP_2.$$s = self, TMP_2), $c).call($d) : option.$size()['$=='](3))) !== nil && (!$a.$$is_boolean || $a == true))) {
            mix['$<<'](($a = self).$rgb.apply($a, Opal.to_a([].concat(Opal.to_a(option)).concat([color_seen]))));
            color_seen = "set";
            } else {
            self.$raise($scope.get('ArgumentError'), "Array argument must contain 3 numerals")
          }}else if (Opal.get('String')['$===']($case)) {if ((($b = option['$=~'](/^#?(?:[0-9a-f]{3}){1,2}$/i)) !== nil && (!$b.$$is_boolean || $b == true))) {
            mix['$<<'](self.$hex(option, color_seen));
            color_seen = "set";
            } else {
            mix['$<<'](self.$rgb_name(option, color_seen));
            color_seen = "set";
          }}else if ($scope.get('Numeric')['$===']($case)) {integer = option.$to_i();
          if ((($b = ($range(30, 49, false))['$include?'](integer)) !== nil && (!$b.$$is_boolean || $b == true))) {
            color_seen = "set"};
          mix['$<<'](integer);}else if (nil['$===']($case)) {color_seen = "set"}else {self.$raise($scope.get('ArgumentError'), "Invalid argument: " + (option.$inspect()))};
          if (color_seen['$==']("set")) {
            colors = $scope.get('ANSI_COLORS_BACKGROUND');
            return color_seen = true;
            } else {
            return nil
          };}, TMP_1.$$s = self, TMP_1), $a).call($b);
        return ($a = self).$wrap.apply($a, Opal.to_a(mix));
      });
      self.$attr_reader("mode");
      Opal.defn(self, '$mode=', function(val) {
        var self = this;
        if (self.cache == null) self.cache = nil;
      ...
      Opal.defn(self, '$wrap', function() {
        ...
        var array_size = arguments.length - 0;
        if(array_size < 0) array_size = 0;
        var ansi_codes = new Array(array_size);
        for($splat_index = 0; $splat_index < array_size; $splat_index++) {
          ansi_codes[$splat_index] = arguments[$splat_index + 0];
        }
        return $rb_plus($rb_plus("\u001b[", $rb_times(ansi_codes, ";")), "m");
      });
      Opal.defn(self, '$simple', function(color_name, background) {
        var self = this;

        if (background == null) {
          background = false
        }
        return $rb_plus(((function() {if (background !== false && background !== nil) {
          return 40
          } else {
          return 30
        }; return nil; })()), $scope.get('ANSI_COLORS')['$[]'](color_name));
      });
      Opal.defn(self, '$rgb', function(red, green, blue, background) {
        var $a, $b, self = this;
        if (self.mode == null) self.mode = nil;
        ...
        if ((($a = ((($b = self.mode['$=='](8)) !== false && $b !== nil) ? $b : self.mode['$=='](16))) !== nil && (!$a.$$is_boolean || $a == true))) {
          return "" + ((function() {if (background !== false && background !== nil) {
            return 4
            } else {
            return 3
          }; return nil; })()) + (self.$rgb_like_value(red, green, blue, self.mode['$=='](16)))
          } else {
          return "" + ((function() {if (background !== false && background !== nil) {
            return 48
            } else {
            return 38
          }; return nil; })()) + (self.$rgb_value(red, green, blue))
        };
      });
      Opal.defn(self, '$hex', function(source, background) {
        var $a, $b, TMP_3, $c, TMP_4, self = this, string = nil, color_code = nil;

        if (background == null) {
          background = false
        }
        string = source.$tr("#", "");
        color_code = (function() {if (string.$size()['$=='](6)) {
          return ($a = ($b = string.$each_char().$each_slice(2)).$map, $a.$$p = (TMP_3 = function(hex_color){var self = TMP_3.$$s || this;
if (hex_color == null) hex_color = nil;
          return hex_color.$join().$to_i(16)}, TMP_3.$$s = self, TMP_3), $a).call($b)
          } else {
          return ($a = ($c = string.$each_char()).$map, $a.$$p = (TMP_4 = function(hex_color_half){var self = TMP_4.$$s || this;
if (hex_color_half == null) hex_color_half = nil;
          return ($rb_times(hex_color_half, 2)).$to_i(16)}, TMP_4.$$s = self, TMP_4), $a).call($c)
        }; return nil; })();
        return ($a = self).$rgb.apply($a, Opal.to_a([].concat(Opal.to_a(color_code)).concat([background])));
      });
      Opal.defn(self, '$rgb_name', function(color_name, background) {
        var $a, self = this, color_code = nil;

        if (background == null) {
          background = false
        }
        if ((($a = color_code = $scope.get('RGB_COLORS')['$[]'](color_name)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return ($a = self).$rgb.apply($a, Opal.to_a([].concat(Opal.to_a(color_code)).concat([background])))
          } else {
          return nil
        };
      });
      Opal.defn(self, '$random', function(background) {
        var self = this;
        ...
        return $rb_plus(((function() {if (background !== false && background !== nil) {
          ...
          return 30
        }; return nil; })()), self.$rand(8));
      });
      Opal.defn(self, '$effect', function(effect_name) {
        var self = this;

        return $scope.get('ANSI_EFFECTS')['$[]'](effect_name);
      });
      Opal.defn(self, '$detect_mode', function() {
        var $a, self = this, $case = nil;

        if ((($a = (($scope.get('RbConfig')).$$scope.get('CONFIG'))['$[]']("host_os")['$=~'](/mswin|mingw/)) !== nil && (!$a.$$is_boolean || $a == true))) {
          if ((($a = $scope.get('ENV')['$[]']("ANSICON")) !== nil && (!$a.$$is_boolean || $a == true))) {
            return 16
          } else if ($scope.get('ENV')['$[]']("ConEmuANSI")['$==']("ON")) {
            return 256
            } else {
            return 0
          }
          } else {
          return (function() {$case = $scope.get('ENV')['$[]']("TERM");if (/-256color$/['$===']($case) || "xterm"['$===']($case)) {return 256}else if (/-color$/['$===']($case) || "rxvt"['$===']($case)) {return 16}else {return 256}})()
        };
      });
      self.$private();
      Opal.defn(self, '$rgb_value', function(red, green, blue) {
        var $a, $b, $c, $d, TMP_5, self = this, gray_possible = nil, sep = nil, gray = nil;

        gray_possible = true;
        sep = 42.5;
        while (gray_possible !== false && gray_possible !== nil) {
        if ((($b = ((($c = ((($d = $rb_lt(red, sep)) !== false && $d !== nil) ? $d : $rb_lt(green, sep))) !== false && $c !== nil) ? $c : $rb_lt(blue, sep))) !== nil && (!$b.$$is_boolean || $b == true))) {
          gray = ($b = ($c = $rb_lt(red, sep), $c !== false && $c !== nil ?$rb_lt(green, sep) : $c), $b !== false && $b !== nil ?$rb_lt(blue, sep) : $b);
          gray_possible = false;};
        sep = $rb_plus(sep, 42.5);};
        if (gray !== false && gray !== nil) {
          return ";5;" + ($rb_plus(232, ($rb_divide(($rb_plus($rb_plus(red.$to_f(), green.$to_f()), blue.$to_f())), 33)).$round()))
          } else {
          return ";5;" + ([16].concat(Opal.to_a(($a = ($b = [red, green, blue].$zip([36, 6, 1])).$map, $a.$$p = (TMP_5 = function(color, mod){var self = TMP_5.$$s || this;
if (color == null) color = nil;if (mod == null) mod = nil;
          return $rb_times(($rb_times(6, ($rb_divide(color.$to_f(), 256)))).$to_i(), mod)}, TMP_5.$$s = self, TMP_5), $a).call($b))).$inject("+"))
        };
      });
      Opal.defn(self, '$rgb_like_value', function(red, green, blue, use_bright) {
        var $a, $b, TMP_6, self = this, color_pool = nil, ansi_color_rgb = nil, key_method = nil, ansi_color = nil;

        if (use_bright == null) {
          use_bright = false
        }
        color_pool = $scope.get('RGB_COLORS_ANSI').$values();
        if (use_bright !== false && use_bright !== nil) {
          color_pool = $rb_plus(color_pool, $scope.get('RGB_COLORS_ANSI_BRIGHT').$values())};
        ansi_color_rgb = ($a = ($b = color_pool).$min_by, $a.$$p = (TMP_6 = function(col){var self = TMP_6.$$s || this;
if (col == null) col = nil;
        return self.$distance([red, green, blue], col)}, TMP_6.$$s = self, TMP_6), $a).call($b);
        key_method = (function() {if ((($a = $rb_lt($scope.get('RUBY_VERSION'), "1.9")) !== nil && (!$a.$$is_boolean || $a == true))) {
          return "index"
          } else {
          return "key"
        }; return nil; })();
        if ((($a = ansi_color = $scope.get('RGB_COLORS_ANSI').$send(key_method, ansi_color_rgb)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return $scope.get('ANSI_COLORS')['$[]'](ansi_color)
          } else {
          ansi_color = $scope.get('RGB_COLORS_ANSI_BRIGHT').$send(key_method, ansi_color_rgb);
          return "" + ($scope.get('ANSI_COLORS')['$[]'](ansi_color)) + ";1";
        };
      });
      return (Opal.defn(self, '$distance', function(rgb1, rgb2) {
        var $a, $b, TMP_7, self = this;

        return ($a = ($b = rgb1.$zip(rgb2)).$inject, $a.$$p = (TMP_7 = function(acc, $c){var self = TMP_7.$$s || this;
if (acc == null) acc = nil;var cur1 = $c[0], cur2 = $c[1];
        return $rb_plus(acc, ($rb_minus(cur1, cur2))['$**'](2))}, TMP_7.$$s = self, TMP_7), $a).call($b, 0);
      }), nil) && 'distance';
    })(Opal.get_singleton_class(self));

    self.mode = self.$detect_mode();

    self.cache = ($a = ($b = $scope.get('Hash')).$new, $a.$$p = (TMP_8 = function(h, k){var self = TMP_8.$$s || this, $a;
if (h == null) h = nil;if (k == null) k = nil;
    return h['$[]='](k, ($a = self).$color.apply($a, Opal.to_a(k)))}, TMP_8.$$s = self, TMP_8), $a).call($b);
  })($scope.base);
};

/* Generated by Opal 0.9.2 */
Opal.modules["friends/serializable"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $hash = Opal.hash, $klass = Opal.klass;

  Opal.add_stubs(['$match', '$to_s', '$deserialization_regex', '$raise', '$deserialization_expectation', '$select', '$!', '$nil?', '$reduce', '$map', '$to_sym', '$[]', '$names', '$new']);
  return (function($base) {
    var $Serializable, self = $Serializable = $module($base, 'Serializable');

    var def = self.$$proto, $scope = self.$$scope;

    Opal.defn(self, '$deserialize', function(str) {
      var $a, $b, TMP_1, $c, $d, TMP_2, self = this, match = nil, args = nil;

      match = str.$to_s().$match(self.$deserialization_regex());
      if (match !== false && match !== nil) {
        } else {
        self.$raise($scope.get('SerializationError'), "Expected \"" + (self.$deserialization_expectation()) + "\"")
      };
      args = ($a = ($b = ($c = ($d = match.$names()).$map, $c.$$p = (TMP_2 = function(name){var self = TMP_2.$$s || this;
if (name == null) name = nil;
      return $hash(name.$to_sym(), match['$[]'](name.$to_sym()))}, TMP_2.$$s = self, TMP_2), $c).call($d).$reduce("merge")).$select, $a.$$p = (TMP_1 = function(_, v){var self = TMP_1.$$s || this;
if (_ == null) _ = nil;if (v == null) v = nil;
      return v['$nil?']()['$!']()}, TMP_1.$$s = self, TMP_1), $a).call($b);
      return self.$new(args);
    });

    (function($base, $super) {
      function $SerializationError(){};
      var self = $SerializationError = $klass($base, $super, 'SerializationError', $SerializationError);
...
/* Generated by Opal 0.9.2 */
Opal.modules["friends/activity"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$require', '$extend', '$match', '$to_s', '$deserialization_regex', '$new', '$[]', '$today', '$parse', '$attr_reader', '$attr_accessor', '$date', '$description', '$pre_match', '$post_match', '$friend_regex_map', '$[]=', '$!', '$empty?', '$each', '$<<', '$shift', '$delete', '$dup', '$first', '$name', '$select', '$==', '$size', '$reject', '$set_n_activities!', '$set_likelihood_score!', '$sort_by', '$-@', '$likelihood_score', '$n_activities', '$gsub', '$include?', '$friend_names', '$uniq', '$scan', '$private', '$<=>']);
  self.$require("date");
  self.$require("paint");
  self.$require("friends/serializable");
  return (function($base) {
    var $Friends, self = $Friends = $module($base, 'Friends');

    var def = self.$$proto, $scope = self.$$scope;

    (function($base, $super) {
      function $Activity(){};
      var self = $Activity = $klass($base, $super, 'Activity', $Activity);

      var def = self.$$proto, $scope = self.$$scope;

      def.description = def._friend_names = nil;
      self.$extend($scope.get('Serializable'));

      Opal.cdecl($scope, 'SERIALIZATION_PREFIX', "- ");

      Opal.defs(self, '$deserialization_regex', function() {
        var self = this;

        return (new RegExp("(" + $scope.get('SERIALIZATION_PREFIX') + ")?((\\d{4}-\\d\\d-\\d\\d)(:\\s)?)?(.+)?"));
      });

      Opal.defs(self, '$deserialize', function(str) {
        var $a, self = this, match = nil;

        match = str.$to_s().$match(self.$deserialization_regex());
        return self.$new($hash2(["date_s", "description"], {"date_s": ((($a = match['$[]'](3)) !== false && $a !== nil) ? $a : $scope.get('Date').$today().$to_s()), "description": match['$[]'](5)}));
      });

      Opal.defs(self, '$deserialization_expectation', function() {
        var self = this;

        return "[YYYY-MM-DD]: [Activity]";
      });

      Opal.defn(self, '$initialize', function($kwargs) {
        var self = this, date_s = nil, description = nil;
        ...
        if ((date_s = $kwargs.$$smap['date_s']) == null) {
          date_s = $scope.get('Date').$today().$to_s()
        }
        if ((description = $kwargs.$$smap['description']) == null) {
          description = nil
        }
        self.date = $scope.get('Date').$parse(date_s);
        return self.description = description;
      });

      self.$attr_reader("date");

      self.$attr_accessor("description");

      Opal.defn(self, '$display_text', function() {
        var $a, $b, self = this, date_s = nil, description_s = nil, match = nil;

        date_s = $scope.get('Paint')['$[]'](self.$date(), "bold");
        description_s = self.$description().$to_s();
        while ((($b = match = description_s.$match(/(\*\*)([^\*]+)(\*\*)/)) !== nil && (!$b.$$is_boolean || $b == true))) {
        description_s = "" + (match.$pre_match()) + ($scope.get('Paint')['$[]'](match['$[]'](2), "bold", "magenta")) + (match.$post_match())};
        return "" + (date_s) + ": " + (description_s);
      });

      Opal.defn(self, '$serialize', function() {
        var self = this;

        return "" + ($scope.get('SERIALIZATION_PREFIX')) + (self.$date()) + ": " + (self.$description());
      });

      Opal.defn(self, '$highlight_friends', function($kwargs) {
        var $a, $b, TMP_1, $c, $d, TMP_2, TMP_3, $e, $f, TMP_4, TMP_5, $g, $h, TMP_6, TMP_7, $i, $j, TMP_9, self = this, friend_regexes = nil, regex_map = nil, matched_friends = nil, possible_matched_friends = nil, introvert = nil;
        ...
        if ((introvert = $kwargs.$$smap['introvert']) == null) {
          throw new Error('expecting keyword arg: introvert')
        }
        friend_regexes = introvert.$friend_regex_map();
        regex_map = ($a = ($b = $scope.get('Hash')).$new, $a.$$p = (TMP_1 = function(h, k){var self = TMP_1.$$s || this;
if (h == null) h = nil;if (k == null) k = nil;
        return h['$[]='](k, [])}, TMP_1.$$s = self, TMP_1), $a).call($b);
        while ((($c = friend_regexes['$empty?']()['$!']()) !== nil && (!$c.$$is_boolean || $c == true))) {
        ($c = ($d = friend_regexes.$dup()).$each, $c.$$p = (TMP_2 = function(friend, regex_list){var self = TMP_2.$$s || this, $a;
if (friend == null) friend = nil;if (regex_list == null) regex_list = nil;
        regex_map['$[]'](regex_list.$shift())['$<<'](friend);
          if ((($a = regex_list['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            return friend_regexes.$delete(friend)
            } else {
            return nil
          };}, TMP_2.$$s = self, TMP_2), $c).call($d)};
        matched_friends = [];
        ($a = ($c = ($e = ($f = regex_map).$select, $e.$$p = (TMP_4 = function(_, arr){var self = TMP_4.$$s || this;
if (_ == null) _ = nil;if (arr == null) arr = nil;
        return arr.$size()['$=='](1)}, TMP_4.$$s = self, TMP_4), $e).call($f)).$each, $a.$$p = (TMP_3 = function(regex, friend_list){var self = TMP_3.$$s || this, $a, match = nil, friend = nil;
          if (self.description == null) self.description = nil;
if (regex == null) regex = nil;if (friend_list == null) friend_list = nil;
        if ((($a = match = self.description.$match(regex)) !== nil && (!$a.$$is_boolean || $a == true))) {
            friend = friend_list.$first();
            matched_friends['$<<'](friend);
            return self.description = "" + (match.$pre_match()) + ("**" + (friend.$name()) + "**") + (match.$post_match());
            } else {
            return nil
          }}, TMP_3.$$s = self, TMP_3), $a).call($c);
        possible_matched_friends = [];
        ($a = ($e = ($g = ($h = regex_map).$reject, $g.$$p = (TMP_6 = function(_, arr){var self = TMP_6.$$s || this;
if (_ == null) _ = nil;if (arr == null) arr = nil;
        return arr.$size()['$=='](1)}, TMP_6.$$s = self, TMP_6), $g).call($h)).$each, $a.$$p = (TMP_5 = function(regex, friend_list){var self = TMP_5.$$s || this, $a;
          if (self.description == null) self.description = nil;
if (regex == null) regex = nil;if (friend_list == null) friend_list = nil;
        if ((($a = self.description.$match(regex)) !== nil && (!$a.$$is_boolean || $a == true))) {
            return possible_matched_friends['$<<'](friend_list)
            } else {
            return nil
          }}, TMP_5.$$s = self, TMP_5), $a).call($e);
        introvert['$set_n_activities!']();
        introvert['$set_likelihood_score!']($hash2(["matches", "possible_matches"], {"matches": matched_friends, "possible_matches": possible_matched_friends}));
        ($a = ($g = ($i = ($j = regex_map).$reject, $i.$$p = (TMP_9 = function(_, arr){var self = TMP_9.$$s || this;
if (_ == null) _ = nil;if (arr == null) arr = nil;
        return arr.$size()['$=='](1)}, TMP_9.$$s = self, TMP_9), $i).call($j)).$each, $a.$$p = (TMP_7 = function(regex, friend_list){var self = TMP_7.$$s || this, $a, $b, TMP_8, match = nil, guessed_friend = nil;
          if (self.description == null) self.description = nil;
if (regex == null) regex = nil;if (friend_list == null) friend_list = nil;
        if ((($a = match = self.description.$match(regex)) !== nil && (!$a.$$is_boolean || $a == true))) {
            guessed_friend = ($a = ($b = friend_list).$sort_by, $a.$$p = (TMP_8 = function(friend){var self = TMP_8.$$s || this;
if (friend == null) friend = nil;
            return [friend.$likelihood_score()['$-@'](), friend.$n_activities()['$-@']()]}, TMP_8.$$s = self, TMP_8), $a).call($b).$first();
            return self.description = "" + (match.$pre_match()) + ("**" + (guessed_friend.$name()) + "**") + (match.$post_match());
            } else {
            return nil
          }}, TMP_7.$$s = self, TMP_7), $a).call($g);
        return self.description = self.description.$gsub("\\", "");
      });

      Opal.defn(self, '$includes_friend?', function($kwargs) {
        var self = this, friend = nil;
        ...
        if ((friend = $kwargs.$$smap['friend']) == null) {
          throw new Error('expecting keyword arg: friend')
        }
        return self.$friend_names()['$include?'](friend.$name());
      });

      Opal.defn(self, '$friend_names', function() {
        var $a, self = this;

        return ((($a = self._friend_names) !== false && $a !== nil) ? $a : self._friend_names = self.$description().$scan(/(\*\*)\w[^\*]*(?=\*\*)/).$uniq());
      });
...
/* Generated by Opal 0.9.2 */
Opal.modules["friends/friend"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  ...
  Opal.add_stubs(['$require', '$extend', '$match', '$to_s', '$deserialization_regex', '$new', '$[]', '$strip', '$map', '$to_proc', '$split', '$attr_accessor', '$empty?', '$name', '$join', '$<<', '$uniq!', '$include?', '$raise', '$delete', '$attr_writer', '$+', '$first', '$private', '$<=>']);
  self.$require("friends/serializable");
  return (function($base) {
    var $Friends, self = $Friends = $module($base, 'Friends');
    ...
    (function($base, $super) {
      function $Friend(){};
      var self = $Friend = $klass($base, $super, 'Friend', $Friend);

      var def = self.$$proto, $scope = self.$$scope;

      def.nicknames = def.n_activities = def.likelihood_score = nil;
      self.$extend($scope.get('Serializable'));

      Opal.cdecl($scope, 'SERIALIZATION_PREFIX', "- ");

      Opal.cdecl($scope, 'NICKNAME_PREFIX', "a.k.a. ");

      Opal.defs(self, '$deserialization_regex', function() {
        var self = this;

        return (new RegExp("(" + $scope.get('SERIALIZATION_PREFIX') + ")?([^\\(]+)(\\((" + $scope.get('NICKNAME_PREFIX') + ".+)\\))?"));
      });
      ...
      Opal.defs(self, '$deserialize', function(str) {
        ...
        match = str.$to_s().$match(self.$deserialization_regex());
        return self.$new($hash2(["name", "nickname_str"], {"name": match['$[]'](2), "nickname_str": match['$[]'](4)}));
      });
      ...
      Opal.defn(self, '$initialize', function($kwargs) {
        var $a, $b, $c, $d, self = this, name = nil, nickname_str = nil;
        ...
        if ((name = $kwargs.$$smap['name']) == null) {
          throw new Error('expecting keyword arg: name')
        }
        if ((nickname_str = $kwargs.$$smap['nickname_str']) == null) {
          nickname_str = nil
        }
        self.name = name.$strip();
        return self.nicknames = ((($a = (($b = nickname_str !== false && nickname_str !== nil) ? ($c = ($d = nickname_str.$split($scope.get('NICKNAME_PREFIX'))['$[]']($range(1, -1, false))).$map, $c.$$p = "strip".$to_proc(), $c).call($d) : nickname_str)) !== false && $a !== nil) ? $a : []);
      });
      ...
      Opal.defn(self, '$serialize', function() {
        ...
        return "" + ($scope.get('SERIALIZATION_PREFIX')) + (self.$to_s());
      });

      Opal.defn(self, '$to_s', function() {
        var $a, $b, TMP_1, self = this, nickname_str = nil;

        if ((($a = self.nicknames['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          return self.$name()};
        nickname_str = ($a = ($b = self.nicknames).$map, $a.$$p = (TMP_1 = function(n){var self = TMP_1.$$s || this;
if (n == null) n = nil;
        return "" + ($scope.get('NICKNAME_PREFIX')) + (n)}, TMP_1.$$s = self, TMP_1), $a).call($b).$join(" ");
        return "" + (self.$name()) + " (" + (nickname_str) + ")";
      });

      Opal.defn(self, '$add_nickname', function(nickname) {
        var self = this;

        self.nicknames['$<<'](nickname);
        return self.nicknames['$uniq!']();
      });

      Opal.defn(self, '$remove_nickname', function(nickname) {
        var $a, self = this;

        if ((($a = self.nicknames['$include?'](nickname)) !== nil && (!$a.$$is_boolean || $a == true))) {
          } else {
          self.$raise($scope.get('FriendsError'), "Nickname \"" + (nickname) + "\" not found for \"" + (self.$name()) + "\"")
        };
        return self.nicknames.$delete(nickname);
      });

      self.$attr_writer("n_activities");

      Opal.defn(self, '$n_activities', function() {
        var $a, self = this;

        return ((($a = self.n_activities) !== false && $a !== nil) ? $a : 0);
      });

      self.$attr_writer("likelihood_score");

      Opal.defn(self, '$likelihood_score', function() {
        var $a, self = this;

        return ((($a = self.likelihood_score) !== false && $a !== nil) ? $a : 0);
      });

      Opal.defn(self, '$regexes_for_name', function() {
        var $a, $b, TMP_2, $c, $d, TMP_3, self = this, splitter = nil, no_leading_backslash = nil, no_leading_asterisks = nil, no_ending_asterisks = nil, no_leading_alphabeticals = nil, no_ending_alphabeticals = nil, chunks = nil;
        ...
        chunks = self.$name().$split($scope.get('Regexp').$new(splitter));
        return ($a = ($b = [chunks, [chunks.$first()]].concat(Opal.to_a(($c = ($d = self.nicknames).$map, $c.$$p = (TMP_3 = function(n){var self = TMP_3.$$s || this;
if (n == null) n = nil;
        return [n]}, TMP_3.$$s = self, TMP_3), $c).call($d)))).$map, $a.$$p = (TMP_2 = function(words){var self = TMP_2.$$s || this;
if (words == null) words = nil;
        return $scope.get('Regexp').$new($rb_plus($rb_plus($rb_plus($rb_plus($rb_plus(no_leading_backslash, no_leading_asterisks), no_leading_alphabeticals), words.$join(splitter)), no_ending_alphabeticals), no_ending_asterisks), (($scope.get('Regexp')).$$scope.get('IGNORECASE')))}, TMP_2.$$s = self, TMP_2), $a).call($b);
      });
...
/* Generated by Opal 0.9.2 */
Opal.modules["friends/friends_error"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      var self = $FriendsError = $klass($base, $super, 'FriendsError', $FriendsError);
...
/* Generated by Opal 0.9.2 */
Opal.modules["friends/introvert"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  function $rb_lt(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs < rhs : lhs['$<'](rhs);
  ...
  Opal.add_stubs(['$require', '$read_file', '$map', '$to_proc', '$sort', '$open', '$puts', '$each', '$friend_with_exact_name', '$raise', '$deserialize', '$<<', '$description', '$highlight_friends', '$unshift', '$friend_with_name_in', '$add_nickname', '$strip', '$remove_nickname', '$!', '$nil?', '$<', '$set_n_activities!', '$sort_by', '$-@', '$n_activities', '$take', '$max', '$with_index', '$ljust', '$name', '$==', '$select', '$includes_friend?', '$[]=', '$strftime', '$date', '$last', '$first', '$+', '$[]', '$new', '$empty?', '$shift', '$map!', '$slice!', '$/', '$*', '$size', '$friend_names', '$n_activities=', '$each_with_object', '$regexes_for_name', '$reject', '$&', '$any?', '$combination', '$flatten', '$likelihood_score=', '$likelihood_score', '$to_i', '$-', '$private', '$exist?', '$chomp', '$===', '$bad_line', '$split', '$read', '$friends_with_name_in', '$join', '$match']);
  self.$require("friends/activity");
  self.$require("friends/friend");
  self.$require("friends/friends_error");
  return (function($base) {
    var $Friends, self = $Friends = $module($base, 'Friends');
    ...
    (function($base, $super) {
      function $Introvert(){};
      var self = $Introvert = $klass($base, $super, 'Introvert', $Introvert);

      var def = self.$$proto, $scope = self.$$scope;

      def.activities = def.friends = def.filename = nil;
      Opal.cdecl($scope, 'DEFAULT_FILENAME', "./friends.md");

      Opal.cdecl($scope, 'ACTIVITIES_HEADER', "### Activities:");

      Opal.cdecl($scope, 'FRIENDS_HEADER', "### Friends:");

      Opal.cdecl($scope, 'GRAPH_DATE_FORMAT', "%b %Y");

      Opal.defn(self, '$initialize', function($kwargs) {
        var self = this, filename = nil;
        ...
        if ((filename = $kwargs.$$smap['filename']) == null) {
          filename = $scope.get('DEFAULT_FILENAME')
        }
        self.filename = filename;
        return self.$read_file();
      });

      Opal.defn(self, '$clean', function() {
        var $a, $b, $c, $d, TMP_1, self = this, descriptions = nil, names = nil;

        descriptions = ($a = ($b = self.activities.$sort()).$map, $a.$$p = "serialize".$to_proc(), $a).call($b);
        names = ($a = ($c = self.friends.$sort()).$map, $a.$$p = "serialize".$to_proc(), $a).call($c);
        ($a = ($d = $scope.get('File')).$open, $a.$$p = (TMP_1 = function(file){var self = TMP_1.$$s || this, $a, $b, TMP_2, $c, TMP_3;
if (file == null) file = nil;
        file.$puts($scope.get('ACTIVITIES_HEADER'));
          ($a = ($b = descriptions).$each, $a.$$p = (TMP_2 = function(desc){var self = TMP_2.$$s || this;
if (desc == null) desc = nil;
          return file.$puts(desc)}, TMP_2.$$s = self, TMP_2), $a).call($b);
          file.$puts();
          file.$puts($scope.get('FRIENDS_HEADER'));
          return ($a = ($c = names).$each, $a.$$p = (TMP_3 = function(name){var self = TMP_3.$$s || this;
if (name == null) name = nil;
          return file.$puts(name)}, TMP_3.$$s = self, TMP_3), $a).call($c);}, TMP_1.$$s = self, TMP_1), $a).call($d, self.filename, "w");
        return self.filename;
      });

      Opal.defn(self, '$add_friend', function($kwargs) {
        var $a, self = this, friend = nil, e = nil, name = nil;
        ...
        if ((($a = self.$friend_with_exact_name(name)) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$raise($scope.get('FriendsError'), "Friend named " + (name) + " already exists")};
        try {
        friend = $scope.get('Friend').$deserialize(name)
        } catch ($err) {if (Opal.rescue($err, [(($scope.get('Serializable')).$$scope.get('SerializationError'))])) {e = $err;
          try {
            self.$raise($scope.get('FriendsError'), e)
          } finally {
            Opal.gvars["!"] = Opal.exceptions.pop() || Opal.nil;
          }
          }else { throw $err; }
      ...
      Opal.defn(self, '$add_activity', function($kwargs) {
        var $a, self = this, activity = nil, e = nil, serialization = nil;
        ...
        if ((serialization = $kwargs.$$smap['serialization']) == null) {
          throw new Error('expecting keyword arg: serialization')
        }
        try {
        activity = $scope.get('Activity').$deserialize(serialization)
        } catch ($err) {if (Opal.rescue($err, [(($scope.get('Serializable')).$$scope.get('SerializationError'))])) {e = $err;
          try {
            self.$raise($scope.get('FriendsError'), e)
          } finally {
        ...
        if ((($a = activity.$description()) !== nil && (!$a.$$is_boolean || $a == true))) {
          activity.$highlight_friends($hash2(["introvert"], {"introvert": self}))};
        self.activities.$unshift(activity);
        return activity;
      });

      Opal.defn(self, '$add_nickname', function($kwargs) {
        var self = this, friend = nil, name = nil, nickname = nil;
        ...
        if ((nickname = $kwargs.$$smap['nickname']) == null) {
          throw new Error('expecting keyword arg: nickname')
        }
        friend = self.$friend_with_name_in(name);
        friend.$add_nickname(nickname.$strip());
        return friend;
      });

      Opal.defn(self, '$remove_nickname', function($kwargs) {
        var self = this, friend = nil, name = nil, nickname = nil;
      ...
      Opal.defn(self, '$list_friends', function() {
        var $a, $b, self = this;

        return ($a = ($b = self.friends).$map, $a.$$p = "name".$to_proc(), $a).call($b);
      });

      Opal.defn(self, '$list_favorites', function($kwargs) {
        var $a, $b, TMP_4, $c, $d, $e, TMP_5, self = this, results = nil, max_str_size = nil, limit = nil;
        ...
        if ((limit = $kwargs.$$smap['limit']) == null) {
          throw new Error('expecting keyword arg: limit')
        }
        if ((($a = ($b = limit['$nil?']()['$!'](), $b !== false && $b !== nil ?$rb_lt(limit, 1) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$raise($scope.get('FriendsError'), "Favorites limit must be positive or unlimited")};
        self['$set_n_activities!']();
        results = ($a = ($b = self.friends).$sort_by, $a.$$p = (TMP_4 = function(friend){var self = TMP_4.$$s || this;
if (friend == null) friend = nil;
        return friend.$n_activities()['$-@']()}, TMP_4.$$s = self, TMP_4), $a).call($b);
        if ((($a = limit['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          } else {
          results = results.$take(limit)
        };
        max_str_size = ($a = ($c = ($d = ($e = results).$map, $d.$$p = "name".$to_proc(), $d).call($e)).$map, $a.$$p = "size".$to_proc(), $a).call($c).$max();
        return ($a = ($d = results.$map()).$with_index, $a.$$p = (TMP_5 = function(friend, index){var self = TMP_5.$$s || this, name = nil, parenthetical = nil;
if (friend == null) friend = nil;if (index == null) index = nil;
        name = friend.$name().$ljust(max_str_size);
          parenthetical = "(" + (friend.$n_activities()) + ((function() {if (index['$=='](0)) {
            return " activities"
            } else {
            return nil
          }; return nil; })()) + ")";
          return "" + (name) + " " + (parenthetical);}, TMP_5.$$s = self, TMP_5), $a).call($d, 0);
      });

      Opal.defn(self, '$list_activities', function($kwargs) {
        var $a, $b, TMP_6, $c, self = this, acts = nil, friend = nil, limit = nil, with$ = nil;
        ...
        if ((with$ = $kwargs.$$smap['with']) == null) {
          throw new Error('expecting keyword arg: with')
        }
        acts = self.activities;
        if ((($a = with$['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          } else {
          friend = self.$friend_with_name_in(with$);
          acts = ($a = ($b = acts).$select, $a.$$p = (TMP_6 = function(act){var self = TMP_6.$$s || this;
if (act == null) act = nil;
          return act['$includes_friend?']($hash2(["friend"], {"friend": friend}))}, TMP_6.$$s = self, TMP_6), $a).call($b);
        };
        if ((($a = limit['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          } else {
          acts = acts.$take(limit)
        };
        return ($a = ($c = acts).$map, $a.$$p = "display_text".$to_proc(), $a).call($c);
      });

      Opal.defn(self, '$graph', function($kwargs) {
        var $a, $b, TMP_7, $c, TMP_8, $d, TMP_9, self = this, friend = nil, acts = nil, act_table = nil, name = nil;
        ...
        friend = self.$friend_with_name_in(name);
        acts = ($a = ($b = self.activities).$select, $a.$$p = (TMP_7 = function(act){var self = TMP_7.$$s || this;
if (act == null) act = nil;
        return act['$includes_friend?']($hash2(["friend"], {"friend": friend}))}, TMP_7.$$s = self, TMP_7), $a).call($b);
        act_table = $hash2([], {});
        ($a = ($c = ($range(acts.$last().$date(), acts.$first().$date(), false))).$each, $a.$$p = (TMP_8 = function(date){var self = TMP_8.$$s || this;
if (date == null) date = nil;
        return act_table['$[]='](date.$strftime($scope.get('GRAPH_DATE_FORMAT')), 0)}, TMP_8.$$s = self, TMP_8), $a).call($c);
        ($a = ($d = acts).$each, $a.$$p = (TMP_9 = function(activity){var self = TMP_9.$$s || this, $a, $b, month = nil;
if (activity == null) activity = nil;
        month = activity.$date().$strftime($scope.get('GRAPH_DATE_FORMAT'));
          return ($a = month, $b = act_table, $b['$[]=']($a, $rb_plus($b['$[]']($a), 1)));}, TMP_9.$$s = self, TMP_9), $a).call($d);
        return act_table;
      });

      Opal.defn(self, '$suggest', function() {
        var $a, $b, $c, TMP_10, $d, $e, self = this, sorted_friends = nil, output = nil;

        self['$set_n_activities!']();
        sorted_friends = ($a = ($b = self.friends).$sort_by, $a.$$p = "n_activities".$to_proc(), $a).call($b);
        output = ($a = ($c = $scope.get('Hash')).$new, $a.$$p = (TMP_10 = function(h, k){var self = TMP_10.$$s || this;
if (h == null) h = nil;if (k == null) k = nil;
        return h['$[]='](k, [])}, TMP_10.$$s = self, TMP_10), $a).call($c);
        output['$[]=']("distant", []);
        while ((($d = ($e = sorted_friends['$empty?']()['$!'](), $e !== false && $e !== nil ?$rb_lt(sorted_friends.$first().$n_activities(), 2) : $e)) !== nil && (!$d.$$is_boolean || $d == true))) {
        output['$[]']("distant")['$<<'](sorted_friends.$shift().$name())};
        output['$[]=']("moderate", ($a = ($d = sorted_friends['$slice!'](0, $rb_divide($rb_times(sorted_friends.$size(), 3), 4)))['$map!'], $a.$$p = "name".$to_proc(), $a).call($d));
        output['$[]=']("close", ($a = ($e = sorted_friends)['$map!'], $a.$$p = "name".$to_proc(), $a).call($e));
        return output;
      });

      Opal.defn(self, '$set_n_activities!', function() {
        var $a, $b, TMP_11, $c, TMP_12, $d, TMP_14, self = this, freq_table = nil;

        freq_table = ($a = ($b = $scope.get('Hash')).$new, $a.$$p = (TMP_11 = function(h, k){var self = TMP_11.$$s || this;
if (h == null) h = nil;if (k == null) k = nil;
        return h['$[]='](k, 0)}, TMP_11.$$s = self, TMP_11), $a).call($b);
        ($a = ($c = self.activities).$each, $a.$$p = (TMP_12 = function(activity){var self = TMP_12.$$s || this, $a, $b, TMP_13;
if (activity == null) activity = nil;
        return ($a = ($b = activity.$friend_names()).$each, $a.$$p = (TMP_13 = function(friend_name){var self = TMP_13.$$s || this, $a, $b;
if (friend_name == null) friend_name = nil;
          return ($a = friend_name, $b = freq_table, $b['$[]=']($a, $rb_plus($b['$[]']($a), 1)))}, TMP_13.$$s = self, TMP_13), $a).call($b)}, TMP_12.$$s = self, TMP_12), $a).call($c);
        return ($a = ($d = freq_table).$each, $a.$$p = (TMP_14 = function(name, count){var self = TMP_14.$$s || this, $a, $b, friend = nil;
if (name == null) name = nil;if (count == null) count = nil;
        friend = self.$friend_with_exact_name(name);
          if (friend !== false && friend !== nil) {
            return (($a = [count]), $b = friend, $b['$n_activities='].apply($b, $a), $a[$a.length-1])
            } else {
            return nil
          };}, TMP_14.$$s = self, TMP_14), $a).call($d);
      });

      Opal.defn(self, '$friend_regex_map', function() {
        var $a, $b, TMP_15, self = this;

        return ($a = ($b = self.friends).$each_with_object, $a.$$p = (TMP_15 = function(friend, hash){var self = TMP_15.$$s || this;
if (friend == null) friend = nil;if (hash == null) hash = nil;
        return hash['$[]='](friend, friend.$regexes_for_name())}, TMP_15.$$s = self, TMP_15), $a).call($b, $hash2([], {}));
      });

      Opal.defn(self, '$set_likelihood_score!', function($kwargs) {
        var $a, $b, TMP_16, $c, TMP_18, self = this, combinations = nil, matches = nil, possible_matches = nil;
        ...
        if ((matches = $kwargs.$$smap['matches']) == null) {
          throw new Error('expecting keyword arg: matches')
        }
        if ((possible_matches = $kwargs.$$smap['possible_matches']) == null) {
          throw new Error('expecting keyword arg: possible_matches')
        }
        combinations = ($a = ($b = ($rb_plus(matches, possible_matches.$flatten())).$combination(2)).$reject, $a.$$p = (TMP_16 = function(friend1, friend2){var self = TMP_16.$$s || this, $a, $b, $c, TMP_17;
if (friend1 == null) friend1 = nil;if (friend2 == null) friend2 = nil;
        return ((($a = (matches['$&']([friend1, friend2])).$size()['$=='](2)) !== false && $a !== nil) ? $a : ($b = ($c = possible_matches)['$any?'], $b.$$p = (TMP_17 = function(group){var self = TMP_17.$$s || this;
if (group == null) group = nil;
          return (group['$&']([friend1, friend2])).$size()['$=='](2)}, TMP_17.$$s = self, TMP_17), $b).call($c))}, TMP_16.$$s = self, TMP_16), $a).call($b);
        return ($a = ($c = self.activities).$each, $a.$$p = (TMP_18 = function(activity){var self = TMP_18.$$s || this, $a, $b, TMP_19, names = nil;
if (activity == null) activity = nil;
        names = activity.$friend_names();
          return ($a = ($b = combinations).$each, $a.$$p = (TMP_19 = function(group){var self = TMP_19.$$s || this, $a, $b, $c, TMP_20;
if (group == null) group = nil;
          if ((names['$&'](($a = ($b = group).$map, $a.$$p = "name".$to_proc(), $a).call($b))).$size()['$=='](2)) {
              return ($a = ($c = group).$each, $a.$$p = (TMP_20 = function(friend){var self = TMP_20.$$s || this, $a;
if (friend == null) friend = nil;
              return ($a = friend, $a['$likelihood_score=']($rb_plus($a.$likelihood_score(), 1)))}, TMP_20.$$s = self, TMP_20), $a).call($c)
              } else {
              return nil
            }}, TMP_19.$$s = self, TMP_19), $a).call($b);}, TMP_18.$$s = self, TMP_18), $a).call($c);
      });

      Opal.defn(self, '$total_friends', function() {
        var self = this;

        return self.friends.$size();
      });

      Opal.defn(self, '$total_activities', function() {
        var self = this;

        return self.activities.$size();
      });

      Opal.defn(self, '$elapsed_days', function() {
        var $a, self = this, sorted_activities = nil;

        if ((($a = $rb_lt(self.activities.$size(), 2)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return 0};
        sorted_activities = self.activities.$sort();
        return ($rb_minus(sorted_activities.$first().$date(), sorted_activities.$last().$date())).$to_i();
      });

      self.$private();

      Opal.defn(self, '$read_file', function() {
        var $a, $b, TMP_21, self = this, state = nil, line_num = nil;

        self.friends = [];
        self.activities = [];
        if ((($a = $scope.get('File')['$exist?'](self.filename)) !== nil && (!$a.$$is_boolean || $a == true))) {
          } else {
          return nil
        };
        state = "initial";
        line_num = 0;
        return ($a = ($b = $scope.get('File').$read(self.filename).$split("\n")).$each, $a.$$p = (TMP_21 = function(line){var self = TMP_21.$$s || this, $case = nil, e = nil;
          if (self.friends == null) self.friends = nil;
          if (self.activities == null) self.activities = nil;
if (line == null) line = nil;
        line_num = $rb_plus(line_num, 1);
          line = line.$chomp();
          return (function() {$case = state;if ("initial"['$===']($case)) {if (line['$==']($scope.get('ACTIVITIES_HEADER'))) {
            } else {
            self.$bad_line($scope.get('ACTIVITIES_HEADER'), line_num)
          };
          return state = "reading_activities";}else if ("reading_friends"['$===']($case)) {try {
          return self.friends['$<<']($scope.get('Friend').$deserialize(line))
          } catch ($err) {if (Opal.rescue($err, [$scope.get('FriendsError')])) {e = $err;
            try {
              return self.$bad_line(e, line_num)
            } finally {
              Opal.gvars["!"] = Opal.exceptions.pop() || Opal.nil;
            }
            }else { throw $err; }
          }}else if ("done_reading_activities"['$===']($case)) {if (line['$==']($scope.get('FRIENDS_HEADER'))) {
            return state = "reading_friends"
            } else {
            return nil
          }}else if ("reading_activities"['$===']($case)) {if (line['$==']("")) {
            return state = "done_reading_activities"
            } else {
            try {
            return self.activities['$<<']($scope.get('Activity').$deserialize(line))
            } catch ($err) {if (Opal.rescue($err, [$scope.get('FriendsError')])) {e = $err;
              try {
                return self.$bad_line(e, line_num)
              } finally {
          ...
          }}else { return nil }})();}, TMP_21.$$s = self, TMP_21), $a).call($b);
      });

      Opal.defn(self, '$friend_with_exact_name', function(name) {
        var $a, $b, TMP_22, self = this, results = nil, $case = nil;

        results = ($a = ($b = self.friends).$select, $a.$$p = (TMP_22 = function(friend){var self = TMP_22.$$s || this;
if (friend == null) friend = nil;
        return friend.$name()['$=='](name)}, TMP_22.$$s = self, TMP_22), $a).call($b);
        return (function() {$case = results.$size();if ((0)['$===']($case)) {return nil}else if ((1)['$===']($case)) {return results.$first()}else {return self.$raise($scope.get('FriendsError'), "More than one friend named " + (name))}})();
      });

      Opal.defn(self, '$friend_with_name_in', function(text) {
        var $a, $b, self = this, friends = nil, $case = nil;

        friends = self.$friends_with_name_in(text);
        return (function() {$case = friends.$size();if ((1)['$===']($case)) {return friends.$first()}else if ((0)['$===']($case)) {return self.$raise($scope.get('FriendsError'), "No friend found for \"" + (text) + "\"")}else {return self.$raise($scope.get('FriendsError'), "More than one friend found for \"" + (text) + "\": " + (($a = ($b = friends).$map, $a.$$p = "name".$to_proc(), $a).call($b).$join(", ")))}})();
      });

      Opal.defn(self, '$friends_with_name_in', function(text) {
        var $a, $b, TMP_23, self = this, regex = nil;

        regex = $scope.get('Regexp').$new(text, (($scope.get('Regexp')).$$scope.get('IGNORECASE')));
        return ($a = ($b = self.friends).$select, $a.$$p = (TMP_23 = function(friend){var self = TMP_23.$$s || this;
if (friend == null) friend = nil;
        return friend.$name().$match(regex)}, TMP_23.$$s = self, TMP_23), $a).call($b);
      });

      return (Opal.defn(self, '$bad_line', function(expected, line_num) {
        var self = this;

        return self.$raise($scope.get('FriendsError'), "Expected \"" + (expected) + "\" on line " + (line_num));
      }), nil) && 'bad_line';
    })($scope.base, null)
  })($scope.base);
};
...
/* Generated by Opal 0.9.2 */
Opal.modules["friends/version"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module;
...
(function(Opal) {
  Opal.dynamic_require_severity = "error";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $hash2 = Opal.hash2, introvert = nil;

  Opal.add_stubs(['$require', '$new', '$puts', '$total_activities', '$elapsed_days', '$total_friends', '$to_s', '$add_friend', '$add_nickname', '$display_text', '$add_activity', '$clean']);
  self.$require("opal");
  self.$require("nodejs");
  self.$require("friends/introvert");
  self.$require("friends/version");
  (function($base) {
    var $Friends, self = $Friends = $module($base, 'Friends');
  ...
  introvert = (($scope.get('Friends')).$$scope.get('Introvert')).$new();
  self.$puts("Initially, " + (introvert.$total_activities()) + " activities across " + ("" + (introvert.$elapsed_days()) + " days for ") + ("" + (introvert.$total_friends()) + " friends."));
  self.$puts("Adding friend: " + (introvert.$add_friend($hash2(["name"], {"name": "Buzz Aldrin"})).$to_s()));
  self.$puts("Adding nickname: " + (introvert.$add_nickname($hash2(["name", "nickname"], {"name": "Buzz", "nickname": "Moonman"})).$to_s()));
  self.$puts("Adding: " + (introvert.$add_activity($hash2(["serialization"], {"serialization": "Walked on the moon with Moonman today."})).$display_text()));
  self.$puts("Now, " + (introvert.$total_activities()) + " activities across " + ("" + (introvert.$elapsed_days()) + " days for ") + ("" + (introvert.$total_friends()) + " friends."));
  introvert.$clean();
  return self.$puts("Wrote out to file.");
})(Opal);
